        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="form-group required ">
                    ...
                    <?php
                    if(!empty($c->getErrors()['domain'])): ?>
                        <div class="help-block"><?= $c->getDomain()['domain']?></div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="form-group required ">
                    ...
                    <?php
                    if(!empty($c->getErrors()['cms_username'])): ?>
                        <div class="help-block"><?= $c->getCmsUsername()['name']?></div>
            ...
            <div class="col-md-5">
                <div class="form-group required ">
                    ...
                    <?php
                    if(!empty($c->getErrors()['cms_password'])): ?>
                        <div class="help-block"><?= $c->getCmsPassword()['cms_password']?></div>
